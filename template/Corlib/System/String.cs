...
#endif
	{
		...
		public static string Join(string separator, params string[] value)
		{
			if (value == null)
			{
				...
				NativeOS.Misc.Panic.Error("Argument Null Exception: value [String.Join]");
			}
		...
		public static string Join(string separator, params object[] values)
		{
			if (values == null)
			{
				NativeOS.Misc.Panic.Error("Argument Null Exception: values [String.Join]");
			}
		...
		public static unsafe string Join(string separator, string[] value, int startIndex, int count)
		{
			...
			if (startIndex < 0)
			{
				NativeOS.Misc.Panic.Error("Argument Out Of Range Exception: startIndex [String.Join]");
				ThrowHelpers.ThrowArgumentOutOfRangeException("startIndex", Environment.GetResourceString("ArgumentOutOfRange_StartIndex"));
			}

			if (count < 0)
			{
				NativeOS.Misc.Panic.Error("Argument Out Of Range Exception: count [String.Join]");
			...
			{
				NativeOS.Misc.Panic.Error("Out of memory Exception:  [String.Join]");
...
//#else
		...
		public override bool Equals(object obj)
		{
			...
			{
				NativeOS.Misc.Panic.Error("Null Reference Exception:  [String.Equals]");
